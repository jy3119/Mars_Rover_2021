...
void setup() {
  ...
  setupDrive();                 // set up Serial/UART Communication with DRIVE's Arduino Nano Every
  setupVision();                // set up Serial/UART Communication with VISION's FPGA
...
void loop() {
  ...
  getVisionData();              // receive obstacle data from VISION via Serial/UART

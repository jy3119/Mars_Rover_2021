...
/////////////////////COMMUNICATE WITH UART/////////////////
       while ((IORD(0x42000,EEE_IMGPROC_STATUS)>>8) & 0xff) { 	//Find out if there are words to read
    	   ...
    	   alt_32 colour_num = IORD(0x42000, 2); //SELECT THE THIRD WORD
    	   alt_32 detected = IORD(0x42000, 3);
    	   alt_32 hori_dist = IORD(0x42000, 4);
    	   alt_32 diag_dist = IORD(0x42000, 5);

    	   //alt_putstr("Writing into UART...\n");

           // writes into the 1st word of I2C MEM
    	   if (colour_num == 0x00000000 && detected == 0x00000001 ){ //{var obs_colour = 'red';}
    		   detected0 = 0x0001;
    		   hori_dist0 = hori_dist;
    		   diag_dist0 = diag_dist;
    	   } else if (colour_num== 0x00000001 && detected == 0x00000001){//blue
    		   detected1 = 0x0001;
    		   hori_dist1 = hori_dist;
    		   diag_dist1 = diag_dist;
    	   } else if (colour_num== 0x00000002 && detected == 0x00000001){ //GREEN
    		   detected2 = 0x0001;
    		   hori_dist2 = hori_dist;
    		   diag_dist2 = diag_dist;
    	   } else if (colour_num== 0x00000003 && detected == 0x00000001){ //MAGENTA
           	   detected3 = 0x0001;
           	   hori_dist3 = hori_dist;
           	   diag_dist3 = diag_dist;
    	   } else if (colour_num== 0x00000004 && detected == 0x00000001){ //YELLOW
           	   detected4 = 0x0001;
           	   hori_dist4 = hori_dist;
           	   diag_dist4 = diag_dist;
    	   }
